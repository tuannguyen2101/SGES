...
//    final AuthorityService authorityService;
    ...
    public UserRestController(BaseService<User, Integer> baseService, AddressService addressService, ReviewsService reviewsService, OrderService orderService, UserService userService) {
        super(baseService);
